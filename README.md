...
On the SimpleShapes2 dataset : descriptors RLM, RLM+f2, RLM+angle4, evaluated with the classifiers MLP and RF (Random Forests), for the numbers of directions 4 and 8 separately.
```python
py project.py --db S2 -c MLP RF -d rlm rlm+f2 rlm+angle -n 4 8
```
