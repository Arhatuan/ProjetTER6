...
from .utils.DescriptorsData import DescriptorsData
from .utils.DescriptorsParameters import DescriptorsParameters
...
def image_processing_v4(imagename, background, step, 
                        descriptorsParameters: DescriptorsParameters) -> DescriptorsData:
